...
See the changelogs for [LEAF-Writer Commons](https://github.com/grognard-xml/grognard/blob/main/apps/commons/CHANGELOG.md) and [LEAF-Writer](https://github.com/grognard-xml/grognard/blob/main/packages/cwrc-leafwriter/CHANGELOG.md) for recent updates.

If you run into a bug or there is a feature you would like to see added, please submit a ticket to [https://github.com/grognard-xml/grognard/issues](https://github.com/grognard-xml/grognard/issues).

If you are interested in adopting/adapting Leaf Writer to a different environment, please consult [this reference](https://github.com/grognard-xml/grognard). You can contact us through a GitHub ticket on any of the LEAF-Writer code repositories.
