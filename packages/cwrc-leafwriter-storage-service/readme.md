...
This is React File Storage component for listing, loading, and saving files from and to the local computer and Git hosting (GitHub and GitLab). It was built to be used in conjunction with [LEAF-Writer-Commons](https://github.com/grognard-xml/grognard), but it is general enough to be freely used anywhere.
...
The [LEAF-Writer Commons](https://leaf-writer.leaf-vre.org/) is running an instance of [LEAF-Writer](https://github.com/grognard-xml/grognard/tree/main/packages/cwrc-leafwriter) that uses the NPM package published from this repository.
...
This component is part of a leaf writer monorepo. Refer to [LEAF-Writer Dev Docs](https://github.com/grognard-xml/grognard) for the project's bigger picture.
