...
export const REGIONAL_BUNDLES: MapTileBundleSpec[] = [
  {
    ...
    source: 'authoritypacks-release',
    url: 'https://github.com/grognard-xml/authoritypacks/releases/latest/download/tibet.pmtiles',
  ...
  },
  {
    ...
    source: 'authoritypacks-release',
    url: 'https://github.com/grognard-xml/authoritypacks/releases/latest/download/china.pmtiles',
  ...
  },
  {
    ...
    source: 'authoritypacks-release',
    url: 'https://github.com/grognard-xml/authoritypacks/releases/latest/download/japan.pmtiles',
