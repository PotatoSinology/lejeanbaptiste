...
**Distribution (2026-07-05):** GitHub Actions builds tagging packs; Grognard downloads binaries from the `authoritypacks` repo. Raw CBDB/DILA for entity enrichment stays a separate user download from HuggingFace / DILA GitHub. Dev sync: `node scripts/sync-authority-packs.mjs <entityDbFolder>`.
